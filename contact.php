...
<head>
	...
	<title>Online Apartment - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> 14 Diederich Street <br/> Khayalethu Residence <br/>Witbank, 1035</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:info@temphome.com">info@temphome.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+27786607474">+27 786 607 474</a>
								</li>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by TempHouses</a></li>
								</ul>
