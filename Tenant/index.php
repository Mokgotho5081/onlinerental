...
<head>
	...
	<title>Online Apartment - Tenant Profile</title>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href=""><i class="fa fa-bookmark"></i> Requested Room</a>
										</li>
										<li>
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-6 col-md-4">
												   ...
												   <div class="form-group">
														<label>Country</label>
														<input name="country" required type="text" class="form-control" value="<?php echo "$mycountry"; ?>">
													</div>
