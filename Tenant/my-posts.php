...
<head>
	...
	<title>Online Rental Apartment - My Posts</title>
		...
		<header id="header">
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>My Requested Apartment(s)</span></li>
					</ol>
			...
			<div class="admin-container-wrapper">
				...
				<div class="container">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href=""><i class="fa fa-folder-open"></i> Other Attachments</a>
										</li>
										<li>
											<a href="my-posts.php"><i class="fa fa-bookmark"></i> Requested Room</a>
										</li>
										<li>
				 ...
				 $stmt = $conn->prepare("SELECT * FROM tbl_room_requests WHERE member_no = '$myid' LIMIT $page1,5");
                                        $stmt->execute();
                                        $resultss = $stmt->fetchAll();
                                        foreach($resultss as $rowss)
                                        {
						 $requestID =   $rowss['id'];
						 $landlord = $rowss['landlord'];
                                                      $date = $rowss['request_date'];					 
										
										
										
                                        $stmt = $conn->prepare("SELECT * FROM tbl_posts WHERE landlord = '$landlord' ORDER BY enc_id DESC LIMIT $page1,5");
                                        $stmt->execute();
										...
										$stmts = $conn->prepare("SELECT * FROM tbl_room_requests WHERE member_no = '$myid'   ");
                                        $stmts->execute();
										...
										$count=$stmts->rowCount();
										   ?>
											...
											<a target="_blank" href="../view-apartment.php?jobid=<?php echo $row['app_id']; ?>">
											...
											<?php 
										    if ($myavatar == null) {
										     print '<center>Your Picture Here</center>';
										    }else{
											...
											<div class="content">
											<h4 class="heading"><?php echo "$type"; ?></h4>
											<p class="location"><i class="fa fa-map-marker text-primary"></i> <strong class="text-primary"><?php // "$jobcountry" ?></strong> <?php echo "$jcity" ?></p>
											<p class="date text-muted font12 font-italic">Requested Date - <?php echo "$date"; ?></p>
											</div>
											...
											<a href="view_request.php?rid=<?php echo $requestID; ?>" class="btn btn-primary btn-hidden btn-lg collapsed" >View Request</a>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Online Rental Apartment is a web design that is developed by TempHome group to make things easier for those who are looking for rental apartments.</p>
