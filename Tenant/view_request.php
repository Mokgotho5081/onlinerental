...
try {
  ...
  $stmt = $conn->prepare("SELECT * FROM tbl_room_requests WHERE id = :rid");
    ...
    {
         $appid = $row1['app_id'];
	$date_requested = $row1['request_date'];
	$status = $row1['status'];
...
<head>
	...
	<title>Online Apartment - View_Request</title>
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<ul class="meta-list clearfix">
										...
										<li>
											<h4 class="heading">Requested date: </h4>
								...
								<?php
						              if ($status == 'Approved') { ?>
									    ...
									    <form action="app/app-image.php?rid=<?php echo $rid;?>" method="POST" enctype="multipart/form-data">
										<div class="row gap-20">
								...
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> '.$status.'</button>';	
								}
