...
$stmt = $conn->prepare("SELECT * FROM tbl_posts WHERE app_id = :appid AND landlord = '$myid'");
...
<head>
	...
	<title>TempHome - Request for Apartment <?php echo "$type"; ?></title>
		...
		<div class="main-wrapper">
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="./">Home</a></li>
						<li><span>Request for apartment <?php echo "$type"; ?></</span></li>
					</ol>
			...
			<div class="section sm">
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Request for apartment <?php echo "$type"; ?></</h3>
						</div>
					...
					<div class="employee-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
							...
							$stmt = $conn->prepare("SELECT * FROM tbl_room_requests WHERE app_id = :appid ORDER BY id LIMIT $page1,16");
							$stmt->bindParam(':appid', $app_id);
                            $stmt->execute();
                            $result = $stmt->fetchAll();
							 foreach($result as $row)
			 ...
			 $date = $row['request_date'];
							...
							$stmtb = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'Tenant' AND member_no = '$emp_id'");
                            $stmtb->execute();
									...
									<div class="employee-grid-item">
										...
										<!--<a target="_blank" href="../employee-detail.php?empid=<?php echo $rowb['member_no']; ?>" class="clearfix">-->
											...
											<div class="content">
												...
												<p class="location"><i class="fa fa-map-marker"></i> <?php echo $rowb['city'] ?>  <?php echo $rowb['country'] ?></p>
											...
											<a href="confirmrequest.php?userid=<?php   echo $rowb['member_no'];   ?>" class="btn btn-block"><i class="fa fa-check"></i> Confirm Request</a>
							...
							?>
								...
								<?php
								$total_records = 0;
								$stmt = $conn->prepare("SELECT * FROM tbl_room_requests WHERE app_id = :appid ORDER BY id");
								$stmt->bindParam(':appid', $app_id);
                                $stmt->execute();
                                $result = $stmt->fetchAll();
								    foreach($result as $row)
