			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="../">Online Apartments</a></li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<?php
                                        ...
                                        $stmt = $conn->prepare("SELECT * FROM tbl_posts WHERE landlord = '$myid' ORDER BY enc_id DESC LIMIT $page1,5");
                                        $stmt->execute();
										...
										$stmts = $conn->prepare("SELECT * FROM tbl_room_requests WHERE landlord = '$myid' and app_id = '$appid'  ");
                                        $stmts->execute();
										...
										$count=$stmts->rowCount();
										   ?>
											...
											<p class="location"><i class="fa fa-map-marker text-primary"></i> <strong class="text-primary"><?php // "$jobcountry" ?></strong> <?php echo "$city" ?></p>
											<p class="date text-muted font12 font-italic">Posted - <?php echo "$posted_date"; ?></p>
											</div>
											...
											<a target="_blank" href="view-applicants.php?appid=<?php echo $row['app_id']; ?>">Tenants (<?php echo $count;   ?>)</a>
											<a href="edit-job.php?appid=<?php echo $row['app_id']; ?>">Edit Post</a>
											<a onclick = "return confirm('Are you sure you want to delete this job ?')" href="app/drop-job.php?id=<?php echo $row['app_id']; ?>">Delete Post</a>
											</div>
											</div>
