											...
											<div class="row gap-20">
												...
												<div class="col-sm-12 col-md-8">
													...
													<div class="form-group">
														...
														<input name="name" placeholder="Enter your name" type="text" class="form-control" value="<?php echo "$compname"; ?>" required>
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Country</label>
														<input name="country" required type="text" class="form-control" value="<?php echo "$country"; ?>" placeholder="Enter your country">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<select name="city" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           {
		                                                    ?> <option <?php if ($city == $row['city_name']) { print ' selected '; } ?> value="<?php echo $row['city_name']; ?>"><?php echo $row['city_name']; ?></option> <?php
