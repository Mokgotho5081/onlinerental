...
<input class="form-control" placeholder="Enter your name" name="name" required type="text"> 
</div>
...
<input class="form-control" placeholder="Enter your lastname" name="lname" required type="text"> 
</div>
